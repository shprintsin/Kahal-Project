...
export function MapViewerClient({ map, shellData, deployments = [] }: MapViewerClientProps) {
  return (
    <SiteShell {...shellData}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              {map.description && (
                <div className="bg-stone-50 dark:bg-stone-900/30 p-6 sm:p-8 lg:p-10 border border-stone-200 dark:border-stone-700/50 h-full">
                  <h3 className="text-xl font-bold text-foreground mb-5 font-display text-right">תיאור</h3>
                  <div
                    className="prose prose-lg prose-stone max-w-none text-right leading-relaxed"
                    dir="rtl"
            ...
            <div className="flex flex-col gap-4">
              <div className="bg-white p-4 sm:p-6 shadow-sm border border-border">
                <h3 className="text-lg font-bold text-foreground mb-4 font-display text-right">פרטים</h3>
                <DlGroup>
                  {(map.year || map.period) && (
                    <DlField label="תקופה">
              ...
              {map.layers && map.layers.length > 0 && (
                <div className="bg-white p-4 sm:p-6 shadow-sm border border-border">
                  <h3 className="text-lg font-bold text-foreground mb-4 font-display text-right">שכבות נתונים</h3>
              ...
              {map.resources && map.resources.length > 0 && (
                <div className="bg-white p-4 sm:p-6 shadow-sm border border-border">
                  <h3 className="text-lg font-bold text-foreground mb-4 font-display text-right">הורדות</h3>
                  <div className="space-y-3">
              ...
              {map.referenceLinks && Array.isArray(map.referenceLinks) && map.referenceLinks.length > 0 && (
                <div className="bg-white p-4 sm:p-6 shadow-sm border border-border">
                  <h3 className="text-lg font-bold text-foreground mb-4 font-display text-right">קישורים</h3>
                  <div className="space-y-3">
