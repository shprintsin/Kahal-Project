        ...
        if (browseMode === 'volumes') {
          ...
          return (
            ...
            >
              ...
              {/* Content */}
              <div className="p-3">
                <h3 className="text-sm font-bold text-brand-primary line-clamp-2 group-hover:text-brand-dark mb-1 font-display">
          ...
          return (
            ...
            >
              ...
              {/* Content */}
              <div className="p-3">
                <h3 className="text-sm font-bold text-brand-primary line-clamp-2 mb-1 font-display">
                  {collection.id}
                </h3>
                <p className="text-xs text-gray-600 italic">
                  {volumeCount} כרכים
