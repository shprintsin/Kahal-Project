  ...
  return (
    <div className="flex mb-16 justify-end gap-6">
        ...
        <a
          ...
          className="bg-brand-dark text-white px-6 py-3 rounded-md flex items-center transition-all duration-300 hover:bg-[rgba(var(--green-darker-rgb),0.8)] hover:shadow-md"
        >
        ...
        <a
          ...
          className="bg-brand-dark text-white px-6 py-3 rounded-md flex items-center justify-around transition-all duration-300 hover:bg-[rgba(var(--green-darker-rgb),0.8)] hover:shadow-md"
        >
